...
import page_object.ConfirmationPage;
...
public class ConfirmationAction {
	 ...
	 public static void Execute() throws Exception{
			...
			// Once some text is stored in this variable can be used later in any other class 
	     	...
	     	ConfirmationPage.sProductName=ConfirmationPage.txt_ProductName().getText();
	        ...
	        // This is all about Verification checks, these does not stop your execution but simply report fail at the end
	     	...
	     	if(!"".equals(ConfirmationPage.sProductName)){
	     	...
	     	ConfirmationPage.sProductPrice= ConfirmationPage.txt_ProductPrice().getText();

	     	if(!"".equals(ConfirmationPage.sProductPrice)){
