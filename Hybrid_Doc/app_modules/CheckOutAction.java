...
public class CheckOutAction {
	 ...
	 public static void Execute() throws Exception{
		...
		// Once some text is stored in this variable can be used later in any other class 
     	...
     	CheckOutPage.sProductName=CheckOutPage.txt_ProductName().getText();
     	...
     	if(!"".equals(CheckOutPage.sProductName)){
     	...
     	CheckOutPage.sProductPrice= CheckOutPage.txt_ProductPrice().getText();

     	if(!"".equals(CheckOutPage.sProductPrice)){
